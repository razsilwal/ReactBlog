              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  </div>
                  {
                    type === 'Register' && (
                      ...
                      <input type="text" name="username" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="johnrai" required="" />
                    </div>
                    )
                  }
                  <div>
                  ...
                  <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{type === 'Register' ? 'Create an account' : 'Login'}</button>
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                     { type === 'Register' ? 'Already have an account?' : "don't have account?" }  <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">{ type === 'Login' ? 'Login here' : 'Create one' }</a>
                  </p>
              </form>
          </div>
      </div>
